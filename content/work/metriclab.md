...
layers:
  - head: Problems
    ...
    text: >-
      MetricLab was starting to have identity problems. One half of the problem was that clients weren't clear about what they did. The other half of the problem was that they didn't look as cutting-edge as they said they were.
  ...
  - _template: fm_layer_quote
    text: We need a complete make over
  - head: Rebrand
    _template: fm_layer_content
    text: >-
      We came up with a new name, logo and website. Most beginnings are humble—so are the designs that accompany them. It's important to get in the game with your best foot forward. However, with success, it's important to keep your identity in line with your growth.  MetricLab had grown substantially since they opened. It was time to level up and match their identity to their high quality services.
      
      
      ## New name
      
      
      We changed the name to **MeticLab**. The old name, ActiveCommLabs LLC suffered in many ways. First off, it wasn't memorable. Second, it was very generic sounding. Thrid, the LLC part made their business sound like a law firm. So we chose a [suggestive naming style](https://www.liquidagency.com/brand-exchange/sti-6-naming-styles/) to keep their name aligned with what they did, but with a much [stronger name.](https://www.martyneumeier.com/strong-vs-weak-names)
      ...
      We created a better logo by using a square shape to relate it visually to a unit of measurement. Also, a square is a stable and timeless shape. A square doesn't look old or new. It just looks stable and balanced. The mL and layout borrows an appearance similar to the periodic table, and that's the point. We wanted to employ all the tricks in the book to align their identity with being scientific, analytical and percise.
      ...
      We designed and developed a brand new website. The old website had bad design, layout and imagery. The image of the girl with the laptop was bad, but the fact that the laptop screen wasn't even turned on made the image even more painful. We wanted the new website to fix all of these problems.
